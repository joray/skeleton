<div id="wrap">
  ...
  <div id="wrapsecond" class="wrap">
  <div class="container containerfull">
  <div class="clear"></div>
        <div id="slidershow" class="slidershow clearfix">

          <?php if ($page['slidershow']) : ?>
              <?php print drupal_render($page['slidershow']); ?>
            <?php endif; ?>
	...
	<div id="footer" >
        <div class="container">
        	<div class="sixteen columns clearfix">
                ...
                <?php print $site_name;?>
                <?php endif;?>
              Powered by <a href="http://www.imreser.com" target="_blank" title="is a internet e-commerce rediscoverer" style="font-weight: bolder;">IMRESER</a>
                </div>
        	</div>
        </div>
    </div>
